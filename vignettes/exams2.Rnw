...
\Abstract{
  This introduction to version~2 of the \proglang{R} package \pkg{exams} is a (slightly)
...
\Address{
  ...
  URL: \url{http://www.rali.boku.ac.at/leisch.html}
}
...
\begin{itemize}
  ...
  \item Exams can be generated by randomly drawing different versions of exercises from a
    ...
    time of writing the function still needs more thorough testing and is hence
...
within \proglang{R} has been developed. This is not part of \pkg{exams}, yet,
but interested readers are welcome to contact the authors.}
