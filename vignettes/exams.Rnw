...
\Abstract{ 
  ...
  considerably extended by \cite{exams:Zeileis+Umlauf+Leisch:2014} to
  also produce HTML output or e-learning exams for \pkg{Moodle}, \pkg{OLAT}/\pkg{OpenOLAT}, etc.
...
Wien (WU Wien, \url{http://www.wu.ac.at/}) is
