...
\Abstract{
  ...
  has been extended in various ways which are not yet reflected in this vignette (e.g.,
  exercises in \proglang{R}/Markdown format instead of \proglang{R}/{\LaTeX}, or
